...
## 🚀 Enhanced Training with SM120 MXFP4

This repository has been enhanced to support **SM120 MXFP4** (Mixed FP4) training for improved efficiency and performance. We are currently conducting dual-GPU training experiments using **RTX 5090D** cards to push the boundaries of accessible LLM training.

### Key Features:
- **SM120 MXFP4 Support**: Advanced mixed precision training with FP4 quantization
- **Dual GPU Training**: Optimized for RTX 5090D dual-card setups
- **Memory Optimization**: Comprehensive GPU memory management strategies
- **Distributed Training**: Enhanced torchrun support with libuv optimizations
- **Experiment Tracking**: Integrated Weights & Biases (wandb) support

### Current Training Setup:
- **Hardware**: Dual RTX 5090D GPUs
- **Precision**: SM120 MXFP4 mixed precision
- **Training Script**: `train_dual_gpu.sh` for distributed training
- **Configuration**: Multiple memory-optimized configs in `configs/dual_gpu/`

### Getting Started with SM120 MXFP4:
```bash
# Run dual GPU training with SM120 MXFP4
bash train_dual_gpu.sh

# Or use specific memory configurations
bash train_dual_gpu.sh --config configs/dual_gpu/optimal_29gb.py
```

For detailed setup instructions, see our [SM120 Torch Setup Guide](docs/sm120_torch_setup.md) and [Distributed Training Guide](docs/distributed_training_guide.md).

## 📚 Documentation

- **[Pipeline Overview](docs/pipeline_overview.md)** - Complete four-stage training pipeline guide
- **[Quick Start Guide](docs/quick_start_guide.md)** - Step-by-step setup and training instructions  
- **[Scripts Reference](docs/scripts_reference.md)** - Detailed reference for all training and evaluation scripts
- **[SM120 Torch Setup](docs/sm120_torch_setup.md)** - SM120 MXFP4 training setup guide
- **[Distributed Training Guide](docs/distributed_training_guide.md)** - Multi-GPU training configuration
- **[GPU Memory Optimization](docs/gpu_memory_optimization_guide.md)** - Memory management strategies
...
We welcome contributions and feedback! If you encounter any issues with:
- SM120 MXFP4 training setup
- Dual GPU training configurations
- Memory optimization strategies
- Distributed training performance
- Or any other aspects of the codebase

Please feel free to **open an issue** on GitHub. We're particularly interested in:
- Performance improvements for RTX 5090D setups
- Memory optimization techniques
- Training stability improvements
- Documentation enhancements

Your feedback helps us make nanochat better for the community!
