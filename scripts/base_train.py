...
activation_checkpoint = False # enable activation checkpointing to trade compute for memory
# Evaluation
...
if os.environ.get("TORCH_COMPILE", "0") == "1":
    ...
    print0("使用eager模式（节省显存）")
if activation_checkpoint:
    print0("Activation checkpointing enabled for transformer blocks")
